                ...
                <div class="stats-grid">
                    <?php if($userRole === 'police'): ?>
                        ...
                        <a href="<?php echo e(route('reports', ['status' => 'investigating'])); ?>" class="stat-card verified">
                            ...
                            <div class="stat-value"><?php echo e($investigatingReports); ?></div>
                        </a>
                        ...
                        <a href="<?php echo e(route('reports', ['status' => 'resolved'])); ?>" class="stat-card" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('users')); ?>" class="stat-card verified">
                            <div class="stat-title">Total Users</div>
                            <div class="stat-value"><?php echo e($totalUsers); ?></div>
                        </a>
                        <a href="<?php echo e(route('users')); ?>" class="stat-card pending">
                            <div class="stat-title">Police Officers</div>
                            <div class="stat-value"><?php echo e($totalPoliceOfficers); ?></div>
                        </a>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Codes\alertdavao2.0.new\AdminSide\admin\resources\views/welcome.blade.php ENDPATH**/ ?>