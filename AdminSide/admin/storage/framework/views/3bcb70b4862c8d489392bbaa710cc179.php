        ...
        <div class="dashboard">
            ...
            <nav class="sidebar">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('personnel')); ?>" class="nav-link <?php echo e(request()->routeIs('personnel') ? 'active' : ''); ?>">
                            <svg class="nav-icon" viewBox="0 0 24 24">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('verification')); ?>" class="nav-link <?php echo e(request()->routeIs('verification') ? 'active' : ''); ?>">
                            <svg class="nav-icon" viewBox="0 0 24 24">
...
</html><?php /**PATH D:\Codes\alertdavao2.0.new\AdminSide\admin\resources\views/layouts/app.blade.php ENDPATH**/ ?>