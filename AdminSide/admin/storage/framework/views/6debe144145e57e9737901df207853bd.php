...
<div class="users-table-container">
    <table class="users-table" id="personnelTable">
        ...
        <tbody>
            ...
            <tr>
                <td class="officer-id"><?php echo e(str_pad($officer->officer_id, 5, '0', STR_PAD_LEFT)); ?></td>
                <td><?php echo e($officer->user->firstname ?? 'N/A'); ?> <?php echo e($officer->user->lastname ?? ''); ?></td>
                <td>
                    <?php if($officer->rank): ?>
                        <span class="rank-badge"><?php echo e($officer->rank); ?></span>
                    <?php else: ?>
                        <span style="color: #9ca3af;">Not Set</span>
                    <?php endif; ?>
                </td>
                <td>
                    <?php if($officer->policeStation): ?>
                        <?php echo e($officer->policeStation->station_name); ?>
                ...
                <td>
                    <?php if($officer->user && $officer->user->role): ?>
                        <?php if($officer->user->role === 'admin'): ?>
                            <span class="status-badge" style="background-color: #dbeafe; color: #1e40af;">ADMIN</span>
                        <?php elseif($officer->user->role === 'police'): ?>
                            <span class="status-badge" style="background-color: #e0e7ff; color: #3730a3;">POLICE</span>
                        <?php else: ?>
                            <span style="color: #9ca3af;"><?php echo e(strtoupper($officer->user->role)); ?></span>
                        <?php endif; ?>
                    <?php else: ?>
                        <span style="color: #9ca3af;">Not Set</span>
                    <?php endif; ?>
                </td>
                <td><?php echo e($officer->user->email ?? 'N/A'); ?></td>
                <td><?php echo e($officer->user->contact ?? 'N/A'); ?></td>
                <td>
                    <?php if($officer->assigned_since): ?>
                        <?php echo e($officer->assigned_since->timezone('Asia/Manila')->format('m/d/Y')); ?>
                ...
                <td>
                    <span class="status-badge <?php echo e(strtolower(str_replace(' ', '-', $officer->status ?? 'active'))); ?>">
                        <?php echo e($officer->status ?? 'Active'); ?>

                    </span>
                </td>
                <td>
                    <button class="action-btn assign-station-btn" data-user-id="<?php echo e($officer->user_id); ?>" title="Assign to Police Station">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Codes\alertdavao2.0.new\AdminSide\admin\resources\views/personnel.blade.php ENDPATH**/ ?>