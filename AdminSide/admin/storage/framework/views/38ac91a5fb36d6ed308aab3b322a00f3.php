    ...
    <div class="content-header">
        <h1 class="content-title">Dashboard Overview</h1>
                ...
                <div class="stats-grid">
                    ...
                    <a href="<?php echo e(route('reports')); ?>" class="stat-card verified">
                        <div class="stat-title">Verified Reports</div>
                        <div class="stat-value">26</div>
                    </a>
                    <a href="<?php echo e(route('reports')); ?>" class="stat-card pending">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Codes\Laravel.ReactNative\AlertDavao2.0\AdminSide\admin\resources\views/welcome.blade.php ENDPATH**/ ?>