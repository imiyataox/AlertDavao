    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (!emailValue.includes('@')) {
                e.preventDefault();
                alert('Invalid Email Format\n\nEmail must contain @ symbol.\nFor example: nicolequim@gmail.com');
                emailInput.focus();
                return false;
            }
        ...
        <?php if(session('success')): ?>
            alert('Registration Successful!\n\nYour account has been created.\n\nIf the email you provided exists, please check your inbox and click the confirmation link to verify your account and gain access.\n\nYou can now login to continue.');
        <?php endif; ?>
    </script>
</body>
</html><?php /**PATH D:\Codes\alertdavao2.0.new\AdminSide\admin\resources\views/auth/register.blade.php ENDPATH**/ ?>